...
export const codes = {
  ...
  // PAL-CV-SYS-012/013/014 were retired when plugin-layout lint moved out of alsc validate.
  SHAPE_INVALID: "PAL-CV-SHAPE-001",
  SHAPE_CONTRACT_INVALID: "PAL-CV-SHAPE-003",
  SHAPE_FILE_MISSING: "PAL-CV-SHAPE-004",
  SHAPE_MARKDOWN_LITERAL_LEAF_REQUIRED: "PAL-CV-SHAPE-005",
  SHAPE_MARKDOWN_LITERAL_LEAF_COLLISION: "PAL-CV-SHAPE-006",
  ...
  ID_PATH_BINDING_MISMATCH: "PAL-RV-ID-001",
...
export const reasons = {
  ...
  DELAMAIN_ACTIVE_OPERATOR_VERSION_UNSUPPORTED: "delamain.active_operator.version_unsupported",
  DELAMAIN_ACTIVE_OPERATOR_FIELD_MISSING: "delamain.active_operator.field_missing",
  DELAMAIN_ACTIVE_OPERATOR_FIELD_INVALID: "delamain.active_operator.field_invalid",
  DELAMAIN_ACTIVE_OPERATOR_STRICT_NULLABLE: "delamain.active_operator.strict_nullable",
  DELAMAIN_STATE_LABEL_REQUIRED: "delamain.state.label.required",
  DELAMAIN_STATE_LABEL_EMPTY: "delamain.state.label.empty",
  DELAMAIN_STATE_OUTCOME_REQUIRED: "delamain.state.outcome.required",
  DELAMAIN_STATE_OUTCOME_TERMINAL_ONLY: "delamain.state.outcome.terminal_only",
  OPERATOR_REF_VERSION_UNSUPPORTED: "operator_ref.version_unsupported",
  OPERATOR_REF_ROSTER_UNAVAILABLE: "operator_ref.roster_unavailable",
  OPERATOR_REF_UNKNOWN: "operator_ref.unknown",
  SHAPE_LEGACY_REQUIRED_KEY: "shape.legacy_required_key",
  SHAPE_MARKDOWN_LITERAL_LEAF_REQUIRED: "shape.markdown_literal_leaf_required",
  SHAPE_MARKDOWN_LITERAL_LEAF_COLLISION: "shape.markdown_literal_leaf_collision",
  ...
  ID_PATH_BINDING_MISMATCH: "identity.path_binding_mismatch",
