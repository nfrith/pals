...
- Statusline pulse is no longer part of `/bootup`. Claude owns it through the plugin MCP lifecycle. If statusline cache data goes stale, use `/reload-plugins`. See [`statusline/CLAUDE.md`](../../statusline/CLAUDE.md).
